...
// Source: pkg/agentenv/generator/accessors.go
//
// Generated by this command:
//
//	mockgen -source pkg/agentenv/generator/accessors.go -package mocks -destination pkg/agentenv/generator/mocks/mocks.go
//
...
import (
	...
	output "github.com/go42-dev/go42x/pkg/agentenv/generator/output"
...
func (m *MockproviderAccessor) Prepare(plan *output.Plan, ctxData map[string]any, cfg config.Provider) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Prepare", plan, ctxData, cfg)
	ret0, _ := ret[0].(error)
	return ret0
}

// Prepare indicates an expected call of Prepare.
func (mr *MockproviderAccessorMockRecorder) Prepare(plan, ctxData, cfg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Prepare", reflect.TypeOf((*MockproviderAccessor)(nil).Prepare), plan, ctxData, cfg)
}
